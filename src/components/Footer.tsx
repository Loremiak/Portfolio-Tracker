            ...
            >
                <Box maxWidth="750px">
                    ...
                    <Typography fontSize={{ xs: '0.75rem', sm: '0.8rem', md: '0.9rem' }} paddingTop="1rem">
                        ...
                        użytkownikom monitorowanie ich inwestycji kryptowalutowych w czasie rzeczywistym. Aplikacja przelicza wartości
                        inwestycji na wybraną walutę (USD), oferując przejrzysty podgląd wartości portfela w postaci wykresów i statystyk.
                        Dzięki intuicyjnemu interfejsowi użytkownicy mogą łatwo analizować swoje inwestycje, śledzić zmiany wartości oraz
