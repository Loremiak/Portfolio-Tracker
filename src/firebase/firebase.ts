...
import { collection, doc, getDoc, getFirestore, query, setDoc, updateDoc, where } from 'firebase/firestore';
...
export { app, auth, db, doc, setDoc, getDoc, updateDoc, collection, query, where };
